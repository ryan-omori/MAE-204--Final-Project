...
l = 0.235; % Distance from robot center to wheel along x-axis
w = 0.15; % Distance from robot center to wheel along y-axis 
...
% Task Setups
% Cube Initial Position and Goal position in Space fram
cube_int=[0 1 0];
cube_goal=[-pi/2 0 -1];
